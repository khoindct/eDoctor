...
import "./AdminClinicManagePage.scss";

const AdminDoctorManagePage = () => {
  ...
  return (
    <Page className="" title="Dashboard">
      ...
      <Box mt={5} />
      <DataList data={dataList} columns={columns} title="Doctor List" />
    </Page>
  );
};

export default AdminDoctorManagePage;
